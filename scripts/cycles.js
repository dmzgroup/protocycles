...
var lasttimer = Date.now() * 0.0005;

function render() {

   requestAnimationFrame(render);
   var timer = Date.now() * 0.0005;
   var delta = timer - lasttimer;
...
*/
   ...
   camera.position.x += delta * axes[0] * 10;
   camera.position.y += delta * axes[3] * 10;
   camera.position.z += delta * axes[1] * 10;
